...
attributes = np.load('../europe_att_batch1.npy')
train_sample_size = attributes.shape[0]

features = np.load('../europe_feat_batch1.npy')
...
np.save('europe_att_batch1_min.npy',data_attribute_min)
np.save('europe_att_batch1_max.npy',data_attribute_max)
